...
const Home = () => (
  <div style={{
    ...
    <div style={{
      ...
      background: '#fff',
      borderRadius: 18,
      boxShadow: '0 6px 32px rgba(25,118,210,0.08)',
      ...
      <div style={{ background: '#e3f2fd', borderRadius: 8, padding: '1rem', marginBottom: 0, fontSize: '1.05rem', color: '#2255a4', fontWeight: 500 }}>
